...
**Scripts info:**
 - `MozafariShallow.py`: Reimplementation of the paper "First-Spike-Based Visual Categorization Using Reward-Modulated STDP" (https://ieeexplore.ieee.org/document/8356226/).
 ...
 - `tutorial.ipynb`: A brief tutorial on designing, training, and evaluating a SNN with SpykeTorch.
